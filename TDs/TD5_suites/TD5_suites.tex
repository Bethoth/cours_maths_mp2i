...
\begin{exo}[Exemples fondamentaux]
Soit \(\lambda\in\R\).
...
\begin{exo}[Théorème des segments emboîtés]
...
\begin{exo}[Moyenne de Cesàro d'une suite]\thlabel{exo:moyenneDeCesàroD'UneSuite}
