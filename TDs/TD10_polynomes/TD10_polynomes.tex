...
\begin{exo}[Algorithme d'Euclide]
...
\begin{exo}[Classique]\thlabel{exo:classiqueSurLesPolynômesScindés}
...
\begin{exo}[Suite de l'exercice précédent, moins classique]
Soit \(P\in\poly[\R]\).
