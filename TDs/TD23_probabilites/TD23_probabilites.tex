...
\begin{enumerate}
    \item On note \(N_k\) le nombre d'apparitions de la face \(k\in\interventierii{1}{6}\) dans la suite des \(n\) lancers. \\ Intuitivement, que peut-on dire de \(N_k\) lorsque \(n\) tend vers \(\pinf\) ? \\
...
On suppose que \(N\) est un entier naturel non-nul fixé.
