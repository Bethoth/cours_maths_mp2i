...
On note \(\Em\) l'ensemble des fonctions en escalier inférieures à \(f\) : \[\Em=\accol{\phi\in\Esc\tq\phi\leq f}\] et \(\Ep\) l'ensemble des fonctions en escalier supérieures à \(f\) : \[\Ep=\accol{\psi\in\Esc\tq f\leq\psi}.\]
